...
{
    /**
     * Die Main-Methode prÃ¼ft, ob Assertions aktiviert sind und startet das
    ...
    public static void main(String[] args)
    {
        if (!assertsEnabled())
        {
            throw new IllegalStateException(
                    "Asserts mÃ¼ssen aktiviert sein: Window > Preferences > Java > Installed JREs -> ausgewaehlte JRE markieren und auf Edit klicken > im erscheinenden Dialog bei Default VM Arguments -ea eingeben");
        }
    ...
    private static Kino erzeugeKinoMitBeispieldaten()
    {
        ...
        Film[] filme = {
                ...
                new Film("Wasser fÃ¼r die Elefanten", 120, FSK.FSK12, false),
