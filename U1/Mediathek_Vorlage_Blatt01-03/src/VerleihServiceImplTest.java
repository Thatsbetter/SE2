...
public class VerleihServiceImplTest
{
    ...
    public void testVerleiheAn()
    {
        ...
        //leihe Medien aus
        _verleihService.verleiheAn(_brian, _medienbestand.getMedien(), datum1);

        //prüft ob die Medien einem Kunden verliehen sind
        assert _verleihService.sindAlleVerliehen(_medienbestand
            .getMedien()) : "Vorbedingung verletzt: alle Medien sind nicht ausgeliehen";
