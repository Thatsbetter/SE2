...
public interface VerleihService extends ObservableService
{
     ...
     * Kunde muss existiern,sonst kann man ihm nichts verleihen
     * @require sindAlleNichtVerliehen(medien)
     * Medium muss nicht verliehen sein 
     * @require ausleihDatum != null
     * Nullexception vermeiden
     * 
     ...
     * 
     * @require kundeImBestand(kunde)
     * Kunde muss existieren, um ihn etwas zu verleihen
     * 
     * @require medienImBestand(medien)
     * Medium muss existieren, um verliehen zu werden
     * 
     */
     ...
     * falls das Medium vergeben ist, kann nicht nochmal verliehen werden
     * 
     * @ensure result != null
     */
     ...
     * 
     * @require kundeImBestand(kunde)
     * falls Kunde nicht existiert kann nicht etwas leihen
     * 
     * @ensure result != null
     */
     ...
     * falls das Medium nicht existiert, kann nicht zurückgenommen werden
     */
     ...
     * 
     * @require medienImBestand(medien)
     * falls das Medium nicht existiert kann nicht verliehen werden
     */
     ...
     * 
     * @require medien != null
     * Nullexception zu vermeiden
     * @require !medien.isEmpty()
     * Falls medienliste leer ist, führt zu Nullexception
     */
     ...
     * 
     * @require istVerliehen(medium)
     * ein Medium kann nicht 2 mal verliehen sein
     * 
     * @ensure (result != null)
     */
