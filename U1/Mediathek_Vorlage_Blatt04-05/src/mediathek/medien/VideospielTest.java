...
public class VideospielTest
{
    ...
    @Test
    public void testBerechneGebuehr()
    {
        Medium medium = getMedium();
        assertEquals(medium.berechneMietgebuehr(1), new Geldbetrag(200));
        assertEquals(medium.berechneMietgebuehr(5), new Geldbetrag(200));
        assertEquals(medium.berechneMietgebuehr(10), new Geldbetrag(200));
