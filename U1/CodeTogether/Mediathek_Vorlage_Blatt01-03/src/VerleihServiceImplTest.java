...
public class VerleihServiceImplTest
{
    ...
    {
        _heute = new Datum(05, 05, 20);
        _liste = new ArrayList<Medium>();
        _liste.add(_abbey);
    ...
    public void testVerleihean()
    {
        ...
        _verleihService.verleiheAn(_homer, _liste, _heute);
        assertTrue(_verleihService.getVerleihkarteFuer(_abbey) != null);

    }

    @Test
    public void testVerliehenIstWirklichVerliehen()
    {
        Datum testDatum = new Datum(20, 3, 2020);
        _verleihService.verleiheAn(_brian, _medienbestand.getMedien(),
                testDatum);

        assertTrue(
                _verleihService.sindAlleVerliehen(_medienbestand.getMedien()));
        assertTrue(_verleihService.getEntleiherFuer(_abbey)
            .equals(_brian));
