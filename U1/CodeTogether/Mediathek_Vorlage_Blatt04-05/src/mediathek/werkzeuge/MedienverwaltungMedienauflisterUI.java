 ...
 * BenutzungsoberflÃ¤che fÃ¼r das MedienverwaltungMedienauflisterWerkzeug.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
class MedienverwaltungMedienauflisterUI
{
    ...
    /**
     * Erzeugt die Tabelle fÃ¼r die Anzeige der Medien.
     */
    ...
    /**
     * Gibt die Medienauflistertabelle (JTable) zurÃ¼ck.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt das MedienverwaltungMedienTableModel der UI zurÃ¼ck.
     * 
     * @ensure result != null
     */
