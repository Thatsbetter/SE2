...
/**
 * Dieses TableModel hÃ¤lt die Verleihkarten, die an der OberflÃ¤che angezeigt
 * werden sollen. FÃ¼r jedes Medium wird zusÃ¤tzlich angezeigt, ob es verliehen
 * ist oder nicht. Aufgabe eines Tablemodels ist es u.a., fÃ¼r die jeweiligen
 * Spalten und Zeilen einer GUI-Tabelle die anzuzeigenden EintrÃ¤ge zu liefern.
 * FÃ¼r jede Zeile weiÃŸ dieses Modell, welche Verleihkarte dort dargestellt wird.
 * 
 * 
 * @author SE2-Team
 * @version SoSe 2021
...
class VerleihkartenTableModel extends AbstractTableModel
{
    ...
    /**
     * PrÃ¼ft, ob fÃ¼r die gegebene Tabellen-Zeile eine Verleihkarte in dem
