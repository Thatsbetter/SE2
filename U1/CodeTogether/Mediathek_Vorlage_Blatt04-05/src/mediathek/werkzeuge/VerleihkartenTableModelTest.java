...
public class VerleihkartenTableModelTest
{
    ...
    public void testeSpaltenDefinition() throws Exception
    {
        ...
        assertEquals("MietgebÃ¼hr (â‚¬)", _model.getColumnName(5));
    }
    ...
    {
        // Dieser Test prÃ¼ft nicht, ob die Ausleihdauer richtig angegeben wird,
        // weil fÃ¼r die Ausgabe der Ausleihdauer auf das heutige Datum
