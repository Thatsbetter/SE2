...
/**
 * Testklasse fÃ¼r den VerleihkartenComparator
 * 
 * @author SE2-Team
 */
public class VerleihkartenComparatorTest
{
    ...
    public void testVerschiedeneKunden()
    {
        ...
        // Unterschiedliche Kunden, unterschiedliche Medien. WÃ¼rde nach den
        // Medien sortiert, so wÃ¼rde sich genau die andere Reihenfolge ergeben.
