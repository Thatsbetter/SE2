...
public class VideospielTest
{
    ...
    {
        Geldbetrag b1 = new Geldbetrag(200);
        assertEquals(_videoSpiel.berechneMietgebuehr(1), b1);
        assertEquals(_videoSpiel.berechneMietgebuehr(2), b1);
        assertEquals(_videoSpiel.berechneMietgebuehr(11), b1);
