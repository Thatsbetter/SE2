...
public class Verleihkarte
{
    ...
    {
        // TODO fÃ¼r Aufgabe 4.2.4: Dummy-Implementation ersetzen, sobald ein
        // Medium die benÃ¶tigte FunktionialitÃ¤t anbietet.

        int mietTage = getAusleihdauer();
        return _medium.berechneMietgebuehr(mietTage);
    }
