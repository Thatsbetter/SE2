...
/**
 * KundenDetailAnzeigerUI beschreibt die grafische BenutzungsoberflÃ¤che fÃ¼r das
...
public class KundenDetailAnzeigerUI
{
    ...
    private void erzeugeKundenAnzeiger()
    {
        ...
        medienAnzeigerScrollPane.setBorder(BorderFactory.createTitledBorder(
                null, "AusgewÃ¤hlter Kunde", TitledBorder.LEADING,
    ...
    /**
     * Gibt die JTextArea, die zur Anzeige des ausgewÃ¤hlten Kunden verwendet
     * wird.
     * 
     * @ensure result != null
     */
