...
/**
 * Ein Verleihprotokollierer schreibt alle VerleihvorgÃ¤nge in eine Datei.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
...
{
    /**
     * TextreprÃ¤sentation fÃ¼r das Ereignis Ausleihe
     */
    public static final String EREIGNIS_AUSLEIHE = "Ausleihe";

    /**
     * TextreprÃ¤sentation fÃ¼r das Ereignis RÃ¼ckgabe
     */
    public static final String EREIGNIS_RUECKGABE = "RÃ¼ckgabe";
    ...
    /**
     * Schreibt eine Ã¼bergebene Verleihkarte ins Protokoll.
     * 
     * @param ereignis Der Name des Verleihereignis: mÃ¶gliche Namen sind durch
