...
public class MediathekWerkzeug
{
    ...
    /**
     * Der Service zum Verleihen und ZurÃ¼cknehmen von Medien.
     */
            ...
            KundenstammService kundenstamm, VerleihService verleihService)
    {
        ...
        _vormerkWerkzeug = new VormerkWerkzeug(_medienbestand, _kundenstamm,
                _verleihService);
        // Erzeuge UI fÃ¼r dieses Werkzeug
    ...
    /**
     * Registriert die Aktion, die ausgefÃ¼hrt wird, um die Rueckgabe anzuzeigen.
     */
    ...
    /**
     * Registriert die Aktion, die ausgefÃ¼hrt wird, um die Vormerkansicht
     * anzuzeigen.
     */
    ...
    /**
     * Registriert die Aktion, die ausgefÃ¼hrt wird, um die Ausleihe anzuzeigen.
     */
