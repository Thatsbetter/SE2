...
/**
 * VormerkUI beschreibt die grafische BenutzungsoberflÃ¤che fÃ¼r das
...
class VormerkUI
{
    ...
    /**
     * Initialisiert die Elemente der BenutzungsoberflÃ¤che.
     * 
    ...
    /**
     * Erzeugt das Panel fÃ¼r die Anzeige der Kunden- und Medien-Tabelle, die
    ...
    /**
     * Erzeugt das Anzeige-Panel, in dem die ausgewÃ¤hlte Medien und der
     * ausgewÃ¤hlte kunde angezeigt werden.
     */
    ...
    /**
     * Setzt die GrÃ¶ÃŸe einer Ã¼bergebenen Widget-Komponente auf -1.
     */
    ...
    /**
     * Gibt den Vormerken-Button zurÃ¼ck.
     * 
     * @ensure result != null
     */
