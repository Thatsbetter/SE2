...
/**
 * PLZ ist eine Postleitzahl mit einer LÃ¤nge von 5 Zeichen und optional "D-"
 * oder "d-" davor.
 * 
 * @author SE2-Team
 * @version SoSe 2021
...
{
    // der benutzte regulÃ¤re Ausdruck zur ÃœberprÃ¼fung der GÃ¼ltigkeit von
    // Postleitzahlen.
    private static final Pattern PLZ_PATTERN = Pattern
        .compile("([dD]-)?([0-9]{5})");

    /**
     * Die Postleitzahl als StringreprÃ¤sentation (z.B. 22761)
     */
    private final String _plz;

    /**
     * Ein mÃ¶glicher, erlaubter prefix;
     */
     ...
     * 
     * @param plz Eine Postleitzahl zur ÃœberprÃ¼fung
     ...
     * sind. Ein eventuelles Prefix wird nicht Ã¼berprÃ¼ft.
     * 
