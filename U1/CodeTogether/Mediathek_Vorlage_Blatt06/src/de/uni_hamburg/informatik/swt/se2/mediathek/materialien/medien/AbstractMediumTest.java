...
/**
 * Testklasse fÃ¼r AbstractMediumTest. Testklassen fÃ¼r konkrete Medienklassen
 * (Beispielsweise DVDTest) sollen von dieser Testklasse erben. So werden fÃ¼r
 * jede konkrete Medienklasse die hier definieren Tests ausgefÃ¼hrt.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
public abstract class AbstractMediumTest
{
    ...
    /**
     * Gibt ein neues konkretes Medium-Objekt zurÃ¼ck. Beispielsweise eine DVD in
     * DVDTest
     */
