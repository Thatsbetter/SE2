...
/**
 * Ein Formatierer fÃ¼r Medien in einer Vormerkliste.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
public class VormerkMedienFormatierer
{
    ...
    /**
     * Initialisiert einen neuen VormerkMedienFormatierer fÃ¼r das angegebene
     * Medium.
     * 
    ...
    /**
     * Liefert das Medium des Formatierers zurÃ¼ck.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt den Namen des dritten Vormerkers zurÃ¼ck. Der String ist leer, wenn
    ...
    /**
     * Gibt den Namen des zweiten Vormerkers zurÃ¼ck. Der String ist leer, wenn
    ...
    /**
     * Gibt den Namen des ersten Vormerkers zurÃ¼ck. Der String ist leer, wenn
    ...
    /**
     * Gibt den Namen des Entleihers zurÃ¼ck. Der String ist leer, wenn kein
     * Entleiher existiert.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt eine Stringdarstellung des Kunden zurÃ¼ck. Der String ist leer, wenn
     * der Ã¼bergebene Kunde null ist.
     * 
