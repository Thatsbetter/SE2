...
/**
 * RueckgabeUIbeschreibt die grafische BenutzungsoberflÃ¤che fÃ¼r das
 * RueckgabeWerkzeug. Sie beinhaltet einen Verleihkartenauflister, einen
 * Verleihkartenanzeiger und einen RÃ¼cknahmebutton.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
class RueckgabeUI
{
    ...
    /**
     * Erzeugt die Elemente der BenutzungsoberflÃ¤che.
     */
    public RueckgabeUI()
    {
        erzeugeHauptPanel();
     ...
     * Verleihkartenanzeiger und RÃ¼cknahme-Button befinden.
     */
    ...
    /**
     * Erzeuge das RÃ¼cknahme-Panel, in dem der Verleihkartenanzeiger und der
     * RÃ¼chnahme-Button liegen.
     */
    ...
    /**
     * Erzeuge das Zusammenfassung-Panel, in dem die ausgewÃ¤hlten Verleihkarten
    ...
    private void erzeugeVerleihkartenAnzeiger()
    {
        ...
        verleihkartenAnzeigerScrollPane
            .setBorder(BorderFactory.createTitledBorder(null,
                    "AusgewÃ¤hlte Verleihkarten", TitledBorder.LEADING,
                    TitledBorder.DEFAULT_POSITION, UIConstants.HEADER_FONT));
    ...
    /**
     * Gibt das VerleihkartenTableModel der UI zurÃ¼ck.
     * 
    ...
    /**
     * Gibt den RÃ¼cknahme-Button zurÃ¼ck.
     * 
     * @return Den RÃ¼cknahme-Button.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt die JTextArea zur Darstellung der ausgewÃ¤hlten Verleihkarte zurÃ¼ck.
     * 
     * @return Die JTextArea zur darstellung der ausgewÃ¤hlten Verleihkarte.
     * 
     * @ensure result != null
     */
    ...
    /**
     * Gibt die Tabelle zur Darstellung der Verleihkarten zurÃ¼ck.
     * 
