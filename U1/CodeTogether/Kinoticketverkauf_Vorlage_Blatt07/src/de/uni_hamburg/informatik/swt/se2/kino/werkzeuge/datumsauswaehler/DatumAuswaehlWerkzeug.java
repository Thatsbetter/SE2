...
/**
 * Mit diesem Werkzeug kann ein Datum ausgewÃ¤hlt werden.
 * 
 * Dieses Werkzeug ist ein eingebettetes Subwerkzeug. Es benachrichtigt sein
 * Kontextwerkzeug, wenn sich das ausgewÃ¤hlte Datum geÃ¤ndert hat.
 * 
 * @author SE2-Team
 * @version SoSe 2021
 */
public class DatumAuswaehlWerkzeug extends Beobachtbar
{
    ...
    /**
     * Initialisiert dieses Werkzeug. Das initial ausgewÃ¤hlte Datum ist der
     * heutige Tag.
     */
    ...
    /**
     * Gibt das im Werkzeug ausgewÃ¤hlte Datum zurÃ¼ck.
     * 
     * @ensure result != null
     */
