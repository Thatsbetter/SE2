...
public final class Datum implements Comparable<Datum>
{
    ...
    // FÃ¼r GÃ¼ltigkeitsprÃ¼fungen und Datumsarithmetik wird intern ein Objekt vom
     ...
     * @param monat Der Monat im Jahr (1..12).
     * @param jahr Das Jahr.
     * @return <code>true</code> wenn drei Ã¼bergebene Zahlen ein gÃ¼ltiges Datum
     ...
     *         ist, einen Wert grÃ¶ÃŸer als 0, falls dieses Datum grÃ¶ÃŸer als datum
     *         ist, sonst 0.
     */
    @Override
    ...
    /**
     * Gibt den Monat (im Jahr) dieses Datums zurÃ¼ck (1..12).
     */
    public int getMonat()
    {
        return _monat;
    ...
    /**
     * Gibt dieses Datum in Millisekunden zurÃ¼ck.
     */
    ...
    /**
     * Gibt dieses Datum formatiert zurÃ¼ck in der Schreibweise Tag.Monat.Jahr.
     * 
     * @ensure result != null
     */
