...
/**
 * Ein Button, mit dem ein Sitzplatz in der BenutzeroberflÃ¤che dargestellt wird.
 * Der Sitzplatz kann ausgewÃ¤hlt und als frei oder als verkauft gekennzeichnet
 * werden.
 * 
 * @author SE2-Team
 * @version SoSe 2021
...
class JPlatzButton extends JButton
{
    ...
    /**
     * Gibt die Farbe zurÃ¼ck, in der der Button-Hintergrund gezeichnet werden
    ...
    /**
     * Gibt den Platz zurÃ¼ck, auf den sich dieser Button bezieht.
     */
    ...
    /**
     * Zeigt diesen Button als ausgewÃ¤hlt oder nicht ausgewÃ¤hlt an.
     * 
     * @param ausgewaehlt <code>true</code>, wenn der Button als ausgewÃ¤hlt
